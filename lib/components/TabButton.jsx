...
export function TabButton({
  ...
  let borderClasses = active ?
    ...
    `border-b-2 border-${color}-500 hover:border-${color}-500 shadow-md active:border-${color}-600`
  ...
  if (isMonotone) {
    ...
    borderClasses = active ?
      `border-b border-gray-200 active:border-gray-200` :
      `border-b border-gray-200 hover:border-white active:border-gray-200`
  }
